...
let cargadas = 0;
const porPagina = 30;
const maxPeliculasCargaInicial = 75; // Limitar la carga inicial a 75 películas
let catalogoPeliculas = []; // Almacenar películas populares cargadas para filtros locales

// Función para mostrar películas en la cuadrícula
function mostrarPeliculas(peliculas) {
    ...
    grid.innerHTML = ''; // Limpiar la cuadrícula actual
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Listener para el botón 'Ver Más' (si aplica - actualmente no hay uno para cargar más allá de las 75 iniciales con este enfoque)
    // const btnMas = document.getElementById('btn-mas');
    // if(btnMas) {
    //     btnMas.addEventListener('click', cargarMasPeliculasPopulares); // Necesitaríamos crear cargarMasPeliculasPopulares
    // }
