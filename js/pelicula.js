    ...
    if (movieId) {
        fetch(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${apiKey}&language=es-ES`)
            ...
            .then(peli => {
                ...
                // Configurar el botón de reseñas
                ...
                if (btnReseñas) {
                    btnReseñas.addEventListener('click', () => {
                        ...
                        window.location.href = `../reseñas.php?id=${encodedId}`;
                    });
                }

                // Configurar el botón de comprar entradas
                ...
                if (btnComprarEntradas) {
                    btnComprarEntradas.addEventListener('click', () => {
                        window.location.href = `../compra-entradas.php?id=${movieId}`;
                    });
                }
            })
            .then(() => {
